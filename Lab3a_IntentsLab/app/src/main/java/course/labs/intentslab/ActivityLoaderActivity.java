...
public class ActivityLoaderActivity extends Activity {
	...
	static private final String CHOOSER_TEXT = "Cargar " + URL + " con:";
	...
	private void startExplicitActivation() {
		...
		startActivityForResult(explicitIntent, GET_TEXT_REQUEST_CODE);//Está tronando en esta llamada
	}
	...
	private void startImplicitActivation() {
        ...
        baseIntent = new Intent(Intent.ACTION_VIEW,direccion);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        String cadena = data.getStringExtra("Resultado");
        if(requestCode == GET_TEXT_REQUEST_CODE && resultCode==RESULT_OK)
	        mUserTextView.setText(cadena);
        else
            mUserTextView.setText("Hubo un error");
    }
}
